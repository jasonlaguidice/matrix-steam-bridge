...
type UserInfo struct {
	...
	Status        PersonaState           `protobuf:"varint,6,opt,name=status,proto3,enum=steambridge.PersonaState" json:"status,omitempty"`
	CurrentGame   string                 `protobuf:"bytes,7,opt,name=current_game,json=currentGame,proto3" json:"current_game,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Friend struct {
	...
	Status        PersonaState           `protobuf:"varint,4,opt,name=status,proto3,enum=steambridge.PersonaState" json:"status,omitempty"`
	CurrentGame   string                 `protobuf:"bytes,5,opt,name=current_game,json=currentGame,proto3" json:"current_game,omitempty"`
	Relationship  FriendRelationship     `protobuf:"varint,6,opt,name=relationship,proto3,enum=steambridge.FriendRelationship" json:"relationship,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_SteamBridge_Proto_steam_bridge_proto_rawDesc = "" +
	...
	"\tuser_info\x18\x01 \x01(\v2\x15.steambridge.UserInfoR\buserInfo\"\x81\x02\n" +
	"\bUserInfo\x12\x19\n" +
	...
	"profileUrl\x12\x1d\n" +
	"\n" +
	"avatar_url\x18\x05 \x01(\tR\tavatarUrl\x121\n" +
	"\x06status\x18\x06 \x01(\x0e2\x19.steambridge.PersonaStateR\x06status\x12!\n" +
	"\fcurrent_game\x18\a \x01(\tR\vcurrentGame\"\x14\n" +
	"\x12FriendsListRequest\"D\n" +
	"\x13FriendsListResponse\x12-\n" +
	"\afriends\x18\x01 \x03(\v2\x13.steambridge.FriendR\afriends\"\x80\x02\n" +
	"\x06Friend\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x04R\asteamId\x12!\n" +
	"\fpersona_name\x18\x02 \x01(\tR\vpersonaName\x12\x1d\n" +
	"\n" +
	"avatar_url\x18\x03 \x01(\tR\tavatarUrl\x121\n" +
	"\x06status\x18\x04 \x01(\x0e2\x19.steambridge.PersonaStateR\x06status\x12!\n" +
	"\fcurrent_game\x18\x05 \x01(\tR\vcurrentGame\x12C\n" +
	"\frelationship\x18\x06 \x01(\x0e2\x1f.steambridge.FriendRelationshipR\frelationship\".\n" +
	...
	"\ais_echo\x18\x06 \x01(\bR\x06isEcho\"`\n" +
	...
	"\x10ResolveVanityURL\x12$.steambridge.ResolveVanityURLRequest\x1a%.steambridge.ResolveVanityURLResponse2\xb1\x02\n" +
	...
	"\x16SendTypingNotification\x12&.steambridge.TypingNotificationRequest\x1a'.steambridge.TypingNotificationResponse2w\n" +
...
var file_SteamBridge_Proto_steam_bridge_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_SteamBridge_Proto_steam_bridge_proto_goTypes = []any{
	...
	(*SessionSubscriptionRequest)(nil), // 31: steambridge.SessionSubscriptionRequest
	(*SessionEvent)(nil),               // 32: steambridge.SessionEvent
}
var file_SteamBridge_Proto_steam_bridge_proto_depIdxs = []int32{
	...
	31, // 26: steambridge.SteamSessionService.SubscribeToSessionEvents:input_type -> steambridge.SessionSubscriptionRequest
	8,  // 27: steambridge.SteamAuthService.LoginWithCredentials:output_type -> steambridge.LoginResponse
	7,  // 28: steambridge.SteamAuthService.LoginWithQR:output_type -> steambridge.QRLoginResponse
	10, // 29: steambridge.SteamAuthService.GetAuthStatus:output_type -> steambridge.AuthStatusResponse
	13, // 30: steambridge.SteamAuthService.ReAuthenticateWithTokens:output_type -> steambridge.TokenReAuthResponse
	14, // 31: steambridge.SteamAuthService.Logout:output_type -> steambridge.LogoutResponse
	16, // 32: steambridge.SteamUserService.GetUserInfo:output_type -> steambridge.UserInfoResponse
	19, // 33: steambridge.SteamUserService.GetFriendsList:output_type -> steambridge.FriendsListResponse
	22, // 34: steambridge.SteamUserService.GetUserStatus:output_type -> steambridge.UserStatusResponse
	24, // 35: steambridge.SteamUserService.ResolveVanityURL:output_type -> steambridge.ResolveVanityURLResponse
	26, // 36: steambridge.SteamMessagingService.SendMessage:output_type -> steambridge.SendMessageResponse
	28, // 37: steambridge.SteamMessagingService.SubscribeToMessages:output_type -> steambridge.MessageEvent
	30, // 38: steambridge.SteamMessagingService.SendTypingNotification:output_type -> steambridge.TypingNotificationResponse
	32, // 39: steambridge.SteamSessionService.SubscribeToSessionEvents:output_type -> steambridge.SessionEvent
